...
The progress, catalog, and large-library cache fixes pass 123 JVM tests across 21 suites, Android lint, debug APK assembly, and Android instrumentation-test compilation. The debug APK is rebuilt before each manual-test handoff.

...
4. [ ] Focused coverage and the full gate pass: 252 JVM tests across 42 suites, lint, debug APK assembly, and Android-test APK assembly. Target-device validation confirms cross-library Series grouping and the inline section label/divider layout. Tutorial readability, grouping persistence, dropdown ordering/icons/divider, and About navigation remain pending.

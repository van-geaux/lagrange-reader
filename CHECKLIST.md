...
- [ ] Add proper playback controls for audiobooks
- [ ] Add skip forward/back actions
- [ ] Add playback speed controls if allowed within read/listen scope
...
- [ ] Add unit tests for download store

...
- [x] Keep the BookOrbit app bottom navigation (Home, Libraries, More) visible when opening Book Detail. Implementation and automated verification are complete; physical-device/UI validation remains pending.

...
- [x] [#36](https://github.com/van-geaux/lagrange-reader/issues/36): play ordered split-MP3 streams as one audiobook with automatic file transitions, book-level chapter/seek/time behavior, and file-aware progress/resume. Automated verification and user-confirmed live validation are complete; inclusion in a release is planned this week. Multi-file offline storage remains separate follow-up scope.

...
4. [ ] Replace composable-owned audiobook playback with Readium 3.0.2's AudioNavigator and official Media3 ExoPlayer adapter hosted by a foreground MediaSessionService, with public media notification, audio-focus/noisy handling, and explicit close lifecycle so playback survives Back, navigation, and app backgrounding.

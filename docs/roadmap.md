...
13. [ ] Add Previous/Next navigation between books in the same series from book details, ordered by series index. Placement and interaction design remain pending.

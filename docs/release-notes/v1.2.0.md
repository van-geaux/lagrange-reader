# Lagrange Reader 1.2.0 — Draft Release Notes

> Draft for review. The current project version remains 1.1.0 until the release version and version code are updated.

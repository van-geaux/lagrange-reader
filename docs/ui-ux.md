...
- [ ] Keep EPUB/PDF whole-file preparation, but replace full-file online preparation for M4B/MP4/audiobooks and CBZ/CBR/CB7 with authenticated range/lazy-page streaming plus bounded disposable caches after the user confirms the final Readium-compatible architecture.

...
- [ ] Validate accessibility, large text, grouping persistence, menu semantics, and About routing. Cross-library grouping and the section label/divider layout are device-validated.

Automated gate: 252 JVM tests across 42 suites, lint, debug APK assembly, and Android-test APK assembly pass. Cross-library grouping and the section label/divider layout are target-device validated; label readability, grouping persistence, and menu layout remain.

...
- [x] Add a functional profile Achievements destination with earned/available summary plus Unlocked and Locked cards; target-server validation passed. Pending follow-up: redesign it with Library-like cards and official achievement symbols after the exact layout is clarified.

...
16. Horizontally swipe the compact book-detail action tiles and confirm every action retains a visible label while selective icons aid scanning. Use Read or Continue reading to enter the reader and verify Preview, Download/Delete local, and Cancel download states still work as applicable; Preview must leave normal progress unchanged.
17. Tap the book-detail cover and confirm it opens in a full-screen dark viewer. Tap the displayed cover to dismiss it, reopen it, and press Android Back to dismiss it. For a series book, tap the labeled series title and confirm the existing Series detail page opens. Confirm Android Back from Series details or book details returns to the appropriate prior browser destination.

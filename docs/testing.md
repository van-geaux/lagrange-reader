...
6. Tap Filter in Browse and verify title/author/series matching, unread/in-progress/finished, format, and sort/direction controls reload the server-backed grid and preserve lazy loading.
7. Return Home and confirm shelves only appear when they contain matching books.

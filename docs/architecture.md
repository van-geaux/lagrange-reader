...
- EPUB uses a local extraction flow:
  ...
  - an always-visible theme-matched footer displays rounded completion, current chapter/count, exact current chapter page/count, and a normalized whole-book location from 1 to 1000. The location uses the same chapter/page fraction as progress sync and deliberately does not claim a physical or rendered whole-book page count
